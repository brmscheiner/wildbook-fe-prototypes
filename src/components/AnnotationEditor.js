...
export default function AnnotationEditor({ name, imageSource }) {
  ...
  return (
    <Card style={{ marginBottom: 40}}>
          ...
          />
          <CardActionArea>
            <CardMedia component="img" image={imageSource} />
            <CardContent>
              <Typography variant="body1">Annotation 3 of 5</Typography>
            </CardContent>
          </CardActionArea>
          <CardActions>
